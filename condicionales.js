...
const Ejercicioss = new ejercicios_js();
//Ejercicioss.expresión_algoritmica();
//Ejercicioss.expresión_algoritmica_lógica();
//Ejercicioss.intercambiar_variable();
//Ejercicioss.calcular_segundos_horas();
//Ejercicioss.Ingresar_radio_de_uncirculo();
//Ejercicioss.procentaje_h_procentaje_j();
//Ejercicioss.tres_cuestionarios();
//Ejercicioss.descuento_compra();
//Ejercicioss.final_calificaciones();
//Ejercicioss.evaluar_npar_nimpar();
//Ejercicioss.ver_alumno_aprobado_reprobado();
//Ejercicioss.compra_mayora100_descuento();
//Ejercicioss.calcular_la_lecturadedos_numeros();
//Ejercicioss.numero_mayor_detres_numeros();
//Ejercicioss.kg_manzana();
//Ejercicioss.mostrar_losdiasdelasemana();
//Ejercicioss.mostrar_bodaspor_decadas();
//Ejercicioss.menu();
//Ejercicioss.suma_delosN_numeros();
//Ejercicioss.suma_par_suma_impar();
//Ejercicioss.conteo_N_numeros();
//Ejercicioss.calificacion_promedio_calificacion_baja();
//Ejercicioss.factorial_numero();
//Ejercicioss.sumatoria_numero();
//Ejercicioss.suma_delospares_promediodeimpares();
//Ejercicioss.sumatoria_salarios();
